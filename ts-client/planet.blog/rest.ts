...
export interface BlogQueryAllTimedoutPostResponse {
  TimedoutPost?: PlanetblogTimedoutPost[];
...
export interface BlogQueryParamsResponse {
  ...
  params?: PlanetblogParams;
}

/**
 * Params defines the parameters for the module.
 */
export type PlanetblogParams = object;

export interface PlanetblogPost {
  /** @format uint64 */
  id?: string;
  title?: string;
  content?: string;
...
export interface PlanetblogSentPost {
  /** @format uint64 */
  id?: string;
  postID?: string;
  title?: string;
...
export interface PlanetblogTimedoutPost {
  /** @format uint64 */
  id?: string;
  title?: string;
  chain?: string;
